...
class mpu6050:
    ...
    def calibrate(self):
        ...
        self.set_calibrated_flag()

    def enable_interrupt(self, value=INTERRPUT_ON_DATA_READY):
        self.bus.write_byte_data(self.address, 0x38, value)
